    ...
    <main class="principal">
        <div class="contenedor tablas">
            ...
            <h2>DATOS DE LA EMPRESA PARA CAPACITACIONES</h2>
                <a href="editempresa.php"><button class="boton-agregar margin-top">+ Editar datos</button></a>
        ...
        <div class="cont-boton">
            <a href="administracion.php"><input class="boton" type="submit" value="Volver"></a>
        </div>
    </main>
    <?php
