...
$errores = [];
$nuevoParticip = new PARTICIPANTES();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $doiElegido = DOI::listarDocId($tipo_doc) ?? null;
                    ...
                    <form method="POST">
                        <table>
                                ...
                                <td>
                                    <div class="input">
                                        <select class="field" id="tipo_doc" name="tipo_doc" value="<?php echo $tipo_doc; ?>">
                                            <option value="<?php if($tipo_doc) {echo  $doiElegido->id_doc; } else { echo ''; } ?>"><?php if($tipo_doc) {echo  $doiElegido->nom_doc; } else { echo '-- Selecc. tipo Doc. --'; } ?></option>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input">
                                        <input type="text" class="field" id="email_particip" name="email_particip" value="<?php echo $email_particip; ?>">
                                    </div>
                                </td>
                            </tr>
                            <tr>
