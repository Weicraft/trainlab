        ...
        <div class="contenedor tablas">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex-simple-center">
                                    <a href="particip?texto=<?php echo $texto; ?>&id_particip=<?php echo $participante->id_particip; ?>&indice=<?php echo $indice; ?>">
                            ...
                            <?php if ($sesionSeccion->estado_sesion == '1') { ?>
                                <td>
                                    <div class="flex-simple-center">
                                        <a href="editparticip?texto=<?php echo $texto; ?>&id_particip=<?php echo $participante->id_particip; ?>&indice=<?php echo $indice; ?>">
                                ...
                                <td>
                                    <div class="flex-simple-center">
                                        <a href="elimparticip?texto=<?php echo $texto; ?>&id_particip=<?php echo $participante->id_particip; ?>&indice=<?php echo $indice; ?>">
                            ...
                            if ($sesionSeccion5->estado_sesion == '1') { ?>
                                <td>
                                    <div class="flex-simple-center">
                                        <a href="asignar?texto=<?php echo $texto; ?>&id_particip=<?php echo $participante->id_particip; ?>&indice=<?php echo $indice; ?>">
            ...
            <div class="flex">
                <div class="cont-boton">
                    <a href="participantes"><input class="boton-grabar" type="submit" value="Volver a Todos los participantes"></a>
                </div>
                <div class="cont-boton">
