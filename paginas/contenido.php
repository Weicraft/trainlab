...
<body>
    ...
    <main class="principal">
            ...
            <div class="diseño_tablas">
                <?php if ($contenido->tipo_content == 1) { ?>
                    <div class="visor">
                        ...
                        <video
                            id="video"
                            src="stream?id_curso=<?= $id_curso ?>&id_content=<?= $id_content ?>&t=<?= time(); ?>"
                            preload="metadata"
        ...
        <div class="cont-boton">
            <a href="curso?id_curso=<?php echo $id_curso; ?>&indice=<?php echo $indice; ?>&texto=<?php echo $texto; ?>"><input class="boton" type="submit" value="Volver"></a>
        </div>
    </main>
    <?php
