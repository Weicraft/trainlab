    ...
    <main class="principal">
        <div class="contenedor tablas">
            ...
            <?php if ($sesionSeccion->estado_sesion == '1') { ?>
                <a href="nuevocurso?indice=<?php echo $indice; ?>"><button class="boton-agregar">+ Agregar Nueva</button></a>
            <?php } ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex-simple-center">
                                    <a href="curso?id_curso=<?php echo $curso->id_curso; ?>&indice=<?php echo $indice; ?>">
                            ...
                            <?php if ($sesionSeccion->estado_sesion == '1') { ?>
                                <td>
                                    <div class="flex-simple-center">
                                        <a href="editcurso?id_curso=<?php echo $curso->id_curso; ?>&indice=<?php echo $indice; ?>">
                                ...
                                <td>
                                    <div class="flex-simple-center">
                                        <a href="elimcurso?id_curso=<?php echo $curso->id_curso; ?>&indice=<?php echo $indice; ?>">
