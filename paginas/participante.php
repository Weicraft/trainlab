                            ...
                            <tr>
                                ...
                                <td><?php
                                    if ($asignacion->fecha_fin) {
                                        echo date("d-m-Y", strtotime($asignacion->fecha_fin));
                                    }
                                    ?></td>

                                <td>
                                    <?php if ($totalContenidos == $contenidosFinalizados && $asignacion->estado_aprob == 'A') { ?>
                                        <a href="vercert?id_curso=<?php echo $asignacion->id_curso; ?>&particip=<?php echo $id_particip; ?>&texto=<?php echo $texto; ?>" target="_blank">
                                ...
                                <?php if ($sesionSeccion->estado_sesion == '1') { ?>
                                    <td>
                                        <div class="flex-simple-center">
                                            <a href="elimasig?texto=<?php echo $texto; ?>&id_asign=<?php echo $asignacion->id_asign; ?>&id_particip=<?php echo $id_particip; ?>&indice=<?php echo $indice; ?>">
                                ...
                                <td>
                                    <?php if ($totalContenidos == $contenidosFinalizados && $asignacion->estado_aprob == 'A') { ?>
                                        <form action="paginas/backend/reiniciarcurso.php" method="POST">
