    ...
    <main class="principal">
        <div class="contenedor tablas">
            ...
            <?php if ($sesionSeccion->estado_sesion == '1') { ?>
                <a href="nuevoparticip?indice=<?php echo $indice; ?>"><button class="boton-agregar">+ Agregar Nuevo</button></a>
            <?php } ?>
            <form action="buscarparticip" method="POST">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex-simple-center">
                                    <a href="particip?id_particip=<?php echo $participante->id_particip; ?>&indice=<?php echo $indice; ?>">
                            ...
                            <?php if ($sesionSeccion->estado_sesion == '1') { ?>
                                <td>
                                    <div class="flex-simple-center">
                                        <a href="editparticip?id_particip=<?php echo $participante->id_particip; ?>&indice=<?php echo $indice; ?>">
                                ...
                                <td>
                                    <div class="flex-simple-center">
                                        <a href="elimparticip?id_particip=<?php echo $participante->id_particip; ?>&indice=<?php echo $indice; ?>">
                            ...
                            if ($sesionSeccion5->estado_sesion == '1') { ?>
                                <td>
                                    <div class="flex-simple-center">
                                        <a href="asignar?id_particip=<?php echo $participante->id_particip; ?>&indice=<?php echo $indice; ?>">
            ...
            <div class="cont-boton">
                <a href="panelprincipal"><input class="boton" type="submit" value="Volver a Panel Principal"></a>
            </div>
        </div>
    </main>
    <?php
...
<script src="paginas/build/js/aulaactivar.js"></script>
