<div class="object-center margin-left margin-right">
    <div>
        <table>
            <tr>
                <td rowspan="3"><img src="paginas/build/img/logo.png" alt="logo" class="logo-saludo"></td>
            </tr>
            <tr>
                <td>
    ...
    <div class="flex-simple-center">
        ...
        <div class="azul">https://demo.trainlab.online/aulavirtual</div>
    ...
    <div class="object-right">
        <?php if ($sesionSeccion->estado_sesion == '1') { ?>
            <a href="administracion" class="btn-gestion margin-right">
...
<script src="paginas/build/js/enlace.js"></script>