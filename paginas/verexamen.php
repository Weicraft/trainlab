            ...
            <div class="contenedor tablas">
                ...
                <?php if ($sesionSeccion->estado_sesion == '1') { ?>
                    <div class="flex-simple">
                        <a href="pregunta?id_curso=<?php echo $id_curso; ?>&indice=<?php echo $indice; ?>&texto=<?php echo $texto; ?>">
                            <button type="button" class="boton-agregar-pregunta" id="agregar-pregunta">Agregar Pregunta</button>
                        </a>
                        <a href="elimexam?id_curso=<?php echo $id_curso; ?>&indice=<?php echo $indice; ?>&texto=<?php echo $texto; ?>">
                ...
                <div class="diseño_form formulario">
                                ...
                                <div class="flex-simple">
                                    ...
                                    <?php if ($sesionSeccion->estado_sesion == '1') { ?>
                                        <div class="margin-left">
                                            <a href="editpreg?id_pregunta=<?php echo $pregunta->id_pregunta; ?>&id_curso=<?php echo $curso->id_curso; ?>&indice=<?php echo $indice; ?>&texto=<?php echo $texto; ?>">
                                        ...
                                        <div class="margin-left">
                                            <a href="elimpreg?id_pregunta=<?php echo $pregunta->id_pregunta; ?>&id_curso=<?php echo $curso->id_curso; ?>&indice=<?php echo $indice; ?>&texto=<?php echo $texto; ?>">
                    ...
                    <div class="flex-simple-center">
                        <a class="boton-salir" href="curso?id_curso=<?php echo $id_curso; ?>&indice=<?php echo $indice; ?>&texto=<?php echo $texto; ?>">Volver</a>
                    </div>
                </div>
            </div>
        </div>
