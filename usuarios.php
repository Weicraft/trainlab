    ...
    <main class="principal">
        <div class="contenedor tablas">
            ...
            <?php if ($sesionSeccion->estado_sesion == '1') { ?>
                <a href="nuevousuario.php?indice=<?php echo $indice; ?>"><button class="boton-agregar">+ Agregar Nuevo usuario</button></a>
            <?php } ?>
            <?php if ($usuarios) { ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex-simple-center">
                                    <a href="editusuario.php?id_user=<?php echo $usuario->id_user; ?>&indice=<?php echo $indice; ?>">
                            ...
                            <td class="flex-simple-center">
                                <a href="editpassword.php?id_user=<?php echo $usuario->id_user; ?>&indice=<?php echo $indice; ?>">
                            ...
                            <td>
                                <div class="flex-simple-center">
                                    <a href="permisos.php?usuario=<?php echo $usuario->usuario; ?>">
                            ...
                            <td>
                                <div class="flex-simple-center">
                                    <a href="elimusuario.php?id_user=<?php echo $usuario->id_user; ?>">
            ...
            <div class="cont-boton">
                <a href="administracion.php"><input class="boton" type="submit" value="Volver a Panel Principal"></a>
            </div>
        </div>
    </main>
    <?php
